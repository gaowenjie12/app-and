 ...
 * 交流会预告
 */
public class CommunicationMeetingForeshowActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        OnionRecycleAdapter noticeBeanOnionRecycleAdapter = new OnionRecycleAdapter<BannerItemBean>(R.layout.item_foreshow_list_layout, bannerItemBeans) {
            @Override
            protected void convert(BaseViewHolder holder, final BannerItemBean item) {
                ...
                holder.setText(R.id.tv_name, "【北京站】合伙人股权分配、" +
                        "股权激励、顶层设计、股...");
                holder.setText(R.id.tv_jianshao, "到场嘉宾：杨东、玉红、刘辉...");
