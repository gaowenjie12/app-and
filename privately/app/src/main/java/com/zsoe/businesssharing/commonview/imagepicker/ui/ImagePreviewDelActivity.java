...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    private void showDeleteDialog() {
      /*  TypedValue outValue = new TypedValue();
        getTheme().resolveAttribute(android.support.v7.appcompat.R.attr.dialogTheme,  outValue, true);
        AlertDialog.Builder builder = new AlertDialog.Builder(this,  outValue.resourceId);
        builder.setTitle("提示");
