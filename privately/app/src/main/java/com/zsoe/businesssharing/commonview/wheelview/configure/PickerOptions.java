package com.zsoe.businesssharing.commonview.wheelview.configure;
...
import com.zsoe.businesssharing.commonview.wheelview.listener.OnOptionsSelectChangeListener;
...
public class PickerOptions {
    ...
    public boolean isRangTime;//是否设置时间范围
