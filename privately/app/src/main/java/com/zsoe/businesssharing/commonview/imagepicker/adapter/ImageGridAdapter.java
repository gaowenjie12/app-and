...
import com.zsoe.businesssharing.commonview.imagepicker.view.SuperCheckBox;
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new OpenPermission2(mActivity).requestPermission(new OpenPermission2.OnPermissionListener() {
                        @Override
...
//            FrecoFactory.getInstance(mActivity).disPlay(holder.ivThumb,imageItem.url,reSizeOption);
            AppImageUtils.displayImage(mActivity, holder.ivThumb, imageItem.url, reSizeOption);
