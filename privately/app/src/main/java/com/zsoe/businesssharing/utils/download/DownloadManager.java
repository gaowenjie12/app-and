package com.zsoe.businesssharing.utils.download;
...
public class DownloadManager {
    ...
    public void cancelDownload(DownloadInfo info){
        ...
        StorageUtils.deleteFile(info.getFileName());
    }
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        File path = new File(StorageUtils.FILE_PATH);
        if (!path.exists()) {
            path.mkdir();
        }
        File file = new File(StorageUtils.FILE_PATH, fileName);
        if (file.exists()) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(StorageUtils.FILE_PATH, fileNameOther);
            file = newFile;
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            File file = new File(StorageUtils.FILE_PATH, downloadInfo.getFileName());
            InputStream is = null;
