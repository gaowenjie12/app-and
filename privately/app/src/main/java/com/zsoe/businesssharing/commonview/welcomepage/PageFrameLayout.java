package com.zsoe.businesssharing.commonview.welcomepage;
...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setUpViews(int layoutIds[], int dot_on, int dot_off) {
        ...
        params.bottomMargin = ScreenUtils.dip2px(getContext(),30);
        ...
        fragments.get(fragments.size() - 1).toMainActivity(new OnClickListener() {
            @Override
    ...
    public void toMainActivity(OnClickListener onClickListener) {
