...
public class LatestNewsActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        OnionRecycleAdapter noticeBeanOnionRecycleAdapter = new OnionRecycleAdapter<BannerItemBean>(R.layout.item_latestnew_layout, bannerItemBeans) {
            @Override
            protected void convert(BaseViewHolder holder, final BannerItemBean item) {
                ...
                holder.setText(R.id.tv_title, "为何马云仅有7%的股份就控制了阿里,孙正义是最大股东却说了不算");
