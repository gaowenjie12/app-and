...
import com.zsoe.businesssharing.commonview.recyclerview.entity.MultiItemEntity;
...
//        return ((MultiItemInterface) mData.get(position)).getItemType();
        T item = (T) mData.get(position);
        if (item != null) {
