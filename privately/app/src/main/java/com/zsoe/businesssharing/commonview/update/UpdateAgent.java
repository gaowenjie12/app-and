...
package com.zsoe.businesssharing.commonview.update;
...
class UpdateAgent implements ICheckAgent, IUpdateAgent, IDownloadAgent {
    ...
    public UpdateAgent(Context context, UpdateInfo mInfo, boolean isManual, boolean isWifiOnly, int notifyId) {
...
//            dialog.show();
            ...
            DialogManager.getInstance().showNewVersionDialog(mContext, info, listener);
        }
    }
