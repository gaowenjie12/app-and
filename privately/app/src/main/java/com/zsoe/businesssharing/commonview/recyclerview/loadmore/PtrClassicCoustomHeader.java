...
public class PtrClassicCoustomHeader extends FrameLayout implements PtrUIHandler {
    ...
    public PtrClassicCoustomHeader(Context context) {
        super(context);
        initViews(null);
    }

    public PtrClassicCoustomHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrClassicCoustomHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.cube_ptr_classic_coustom_header, this);
