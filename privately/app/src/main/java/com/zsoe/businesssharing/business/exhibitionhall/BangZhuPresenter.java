...
public class BangZhuPresenter extends BasePresenter<BangZhuActivity> {
    ...
    protected void onCreate(Bundle savedState) {
        ...
        restartableFirst(REQUEST_LOGIN,
                ...
                new NetCallBack<BangZhuActivity, List<ItemWenZhangBean>>() {
                    @Override
                    public void callBack(BangZhuActivity v, List<ItemWenZhangBean> noticeBeanList) {
                ...
                new BaseToastNetError<BangZhuActivity>());
