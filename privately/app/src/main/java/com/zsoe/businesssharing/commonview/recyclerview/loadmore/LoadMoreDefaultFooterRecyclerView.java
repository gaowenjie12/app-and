...
public class LoadMoreDefaultFooterRecyclerView extends RelativeLayout implements LoadMoreUIHandler {
    ...
    public LoadMoreDefaultFooterRecyclerView(Context context, int empty) {
        this(context, null);
    ...
    private void setupViews() {
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, emptyHeight);
