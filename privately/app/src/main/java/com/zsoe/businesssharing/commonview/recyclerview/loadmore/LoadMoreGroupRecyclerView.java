...
public class LoadMoreGroupRecyclerView extends RelativeLayout implements LoadMoreUIHandler {
    ...
    public void updateEmptyView(String msg, int drawIds) {
        TextView tv_empty = (TextView) ll_empty_view.findViewById(R.id.tv_empty);
        tv_empty.setText(msg);
        ImageView iv_empty = (ImageView) ll_empty_view.findViewById(R.id.iv_empty);
        iv_empty.setImageResource(drawIds);
    }
