package com.zsoe.businesssharing.commonview.dropfilter.typeview;
...
import com.zsoe.businesssharing.commonview.dropfilter.FocusGridLayoutManager;
import com.zsoe.businesssharing.commonview.dropfilter.adapter.MultiGridAdapter;
import com.zsoe.businesssharing.commonview.dropfilter.interfaces.OnFilterDoneListener;
import com.zsoe.businesssharing.commonview.dropfilter.util.MLog;
        ...
        switch (view.getId()) {
            ...
            case R.id.bt_reset://重置
                ...
                if (bed_list.get(0).isSelect()
                    ...
                    ToastUtils.showShort("已经是重置状态啦！大人");
                } else {
