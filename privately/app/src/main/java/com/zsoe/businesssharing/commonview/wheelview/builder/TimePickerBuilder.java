package com.zsoe.businesssharing.commonview.wheelview.builder;
...
import com.zsoe.businesssharing.commonview.wheelview.configure.PickerOptions;
import com.zsoe.businesssharing.commonview.wheelview.listener.CustomListener;
import com.zsoe.businesssharing.commonview.wheelview.listener.OnTimeSelectChangeListener;
...
import com.zsoe.businesssharing.commonview.wheelview.view.WheelView;
...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setDate(Calendar date) {
        ...
        mPickerOptions.date.set(Calendar.SECOND, 0);
    ...
    public TimePickerBuilder setRangDate(Calendar startDate, Calendar endDate) {
        ...
        mPickerOptions.startDate.set(Calendar.SECOND, 0);
        mPickerOptions.endDate.set(Calendar.SECOND, 0);

        return this;
    }

    public TimePickerBuilder setRangTime(boolean isRangTime) {
        mPickerOptions.isRangTime = isRangTime;
        return this;
    }

    public TimePickerBuilder setIsToday(boolean isToday) {
        mPickerOptions.isToday = isToday;
        return this;
    }
