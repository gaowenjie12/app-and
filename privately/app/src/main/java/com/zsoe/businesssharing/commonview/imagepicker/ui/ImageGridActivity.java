...
import com.zsoe.businesssharing.commonview.imagepicker.ImageDataSource;
...
import com.zsoe.businesssharing.commonview.imagepicker.adapter.ImageFolderAdapter;
import com.zsoe.businesssharing.commonview.imagepicker.adapter.ImageGridAdapter;
...
public class ImageGridActivity extends BaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected boolean isOrigin = false;  //是否选中原图
...
//        imagePicker.clear();
    ...
    public void onImageItemClick(View view, ImageItem imageItem, int position) {
        ...
        if (imagePicker.isMultiMode()) {
            Intent intent = new Intent(ImageGridActivity.this, ImagePreviewActivity.class);
//           Exception thrown launching activities in ProcessRecord{563e6be 29255:com.face2facelibrary/u0a165}
//            android.os.TransactionTooLargeException: data parcel size 606664 bytes
...
//            intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imagePicker.getCurrentImageFolderItems());
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            if (imagePicker.getSelectLimit() != Integer.MAX_VALUE) {
                mBtnOk.setText(getString(R.string.select_complete, imagePicker.getSelectImageCount(), imagePicker.getSelectLimit()));
            } else {
                mBtnOk.setText(getString(R.string.select_complete_select, imagePicker.getSelectImageCount() + ""));
            }
...
//        Bitmap bitmap = ImageCompressUtils.getScaledBitmap(path);
//        if(bitmap != null) {
