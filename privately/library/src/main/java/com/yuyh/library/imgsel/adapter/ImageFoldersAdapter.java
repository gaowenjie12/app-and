...
public class ImageFoldersAdapter extends RecyclerView.Adapter<ImageFoldersAdapter.ViewHolder> {
    ...
    private List<Folder> mMediaFolderList;
    private int mCurrentImageFolderIndex;


    public ImageFoldersAdapter(Context context, List<Folder> mediaFolderList, int position) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        final Folder mediaFolder = mMediaFolderList.get(position);
        String folderCover = mediaFolder.cover.thumbnailPath;
        String folderName = mediaFolder.name;
        int imageSize = mediaFolder.images.size();
        ...
        ISNav.getInstance().displayImage(mContext, folderCover, holder.mImageCover);
